    ...
    public IrrigationAdvisor(String uname) {
        ...
        try {
            bgImage = javax.imageio.ImageIO.read(
                new java.io.File("src/LoginPage/assets/bg.jpg")
            );
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        // Advice area inside a semi-transparent panel
        JPanel advicePanel = new JPanel();
        advicePanel.setBounds(20, 110, 460, 300);
        advicePanel.setBackground(new Color(0, 0, 0, 120)); 
        ...
        adviceArea.setBackground(new Color(0,0,0,0)); 

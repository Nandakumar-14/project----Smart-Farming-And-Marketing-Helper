...
public class CropSearcher {
    ...
    public String display() {
        try {
            // Read JSON file
            String path = "src/CropRecommender/tn_districts_seasons_crops.json";
            ...
            StringBuilder suggestionBuilder = new StringBuilder("Recommended crops:\n");
            for (int i = 0; i < crops.length(); i++) {
                suggestionBuilder.append("• ").append(crops.getString(i)).append("\n");
            }
